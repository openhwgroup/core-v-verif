...
clean_all: clean clean_riscv-dv clean_test_programs clean-bsp clean_compliance clean_embench clean_dpi_dasm_spike clean_gen_linker_files clean_svlib clean_temp_files
	rm -rf $(CV_CORE_PKG)
