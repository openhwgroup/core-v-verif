...
if {$rvcores ne ""} {
    ...
    add wave -group "Software Debugging" $rvcores/tracer_i/insn_disas
    add wave -group "Software Debugging" $rvcores/tracer_i/insn_pc
    add wave -group "Software Debugging" $rvcores/tracer_i/insn_val
    ...
    if {$fpuprivate ne ""} {
	add wave -group "Software Debugging" $rvcores/id_stage_i/registers_iregister_file_i/mem_fp
    }
