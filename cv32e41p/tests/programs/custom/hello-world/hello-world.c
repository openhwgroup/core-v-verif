...
*******************************************************************************
**
** Sanity test for the CV32E41P core.  Reads the MVENDORID, MISA, MARCHID and
...
int main(int argc, char *argv[])
{
    ...
    if (misa_rval != EXP_MISA) {
      printf("\tERROR: CSR MISA reads as 0x%x - should be 0x%x for this release of CV32E41P!\n\n", misa_rval, EXP_MISA);
      return EXIT_FAILURE;
    }

    /* Check MARCHID CSR: 0x4 is the value assigned by the RISC-V Foundation to CV32E41P */
    if (marchid_rval != 0x00000004) {
      printf("\tERROR: CSR MARCHID reads as 0x%x - should be 0x00000004 for CV32E41P.\n\n", marchid_rval);
      return EXIT_FAILURE;
    }

    /* Check MIMPID CSR: 0x0 is the value assigned by the OpenHW Group to the first release of CV32E41P */
    if (mimpid_rval != 0x00000000) {
      printf("\tERROR: CSR MIMPID reads as 0x%x - should be 0x00000000 for this release of CV32E41P.\n\n", mimpid_rval);
      return EXIT_FAILURE;
    }

    /* Print a banner to stdout and interpret MISA CSR */
    printf("\nHELLO WORLD!!!\n");
    printf("This is the OpenHW Group CV32E41P CORE-V processor core.\n");
    printf("CV32E41P is a RISC-V ISA compliant core with the following attributes:\n");
