...
are modeled after Vincent Driessen's [git branching model](https://nvie.com/posts/a-successful-git-branching-model/).
After becoming an OpenHW Contributor, you can use this file to safely test whether you have the appropriate priviledges for this repo.
Try this:
